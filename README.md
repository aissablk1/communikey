...
- **Transports** : inbox coopératif (universel) · injection **cmux + tmux** (✓) · bridges.
...
**Livré & testé** : inbox coopératif · injection **cmux + tmux** state-aware + graphe familial ·
crypto E2E + vault · recovery Shamir · mémoire/journal.
**En route** : backend screen/ConPTY · adaptateurs Codex/Gemini · passkey · réseau multi-machine
